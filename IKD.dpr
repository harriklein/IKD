...
uses
  ...
  ufrm_ConfigPrint in 'src\ufrm_ConfigPrint.pas' {frm_ConfigPrint: TFrame},
  ...
  ufrm_PoS in 'src\ufrm_PoS.pas' {frm_PoS: TFrame},
  ufrm_Report in 'src\ufrm_Report.pas' {frm_Report: TFrame},
  ufrm_PoSSummary in 'src\ufrm_PoSSummary.pas' {frm_PoSSummary: TFrame},
  unt_Class in 'src\unt_Class.pas',
